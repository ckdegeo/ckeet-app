      ...
      <div className="flex flex-col gap-4 flex-shrink-0">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="space-y-2">
            <div className="h-8 w-48 bg-[var(--on-background)]/10 rounded-lg"></div>
            <div className="h-4 w-96 bg-[var(--on-background)]/10 rounded"></div>
          </div>
          
          {/* Botão de aviso skeleton */}
          <div className="w-10 h-10 bg-[var(--on-background)]/10 rounded-full"></div>
        </div>
      </div>
                ...
                {[1, 2, 3, 4, 5].map((productIndex) => (
                  ...
                  >
                    ...
                    <div className="p-4 space-y-2">
                      ...
                      {/* Botão importar skeleton */}
                      <div className="h-9 w-full bg-[var(--on-background)]/10 rounded-lg mt-3"></div>
                    </div>
                  </div>
                ))}
              </div>
