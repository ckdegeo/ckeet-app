    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="h-11 w-24 bg-[var(--on-background)]/10 rounded-lg"></div>
          <div className="h-11 w-32 bg-[var(--on-background)]/10 rounded-lg"></div>
          <div className="h-11 w-40 bg-[var(--on-background)]/10 rounded-lg"></div>
        </div>
      </div>
                  ...
                  >
                    ...
                    <div className="p-4 space-y-2">
                      ...
                      <div className="flex gap-2 mt-3">
                        <div className="h-8 flex-1 bg-[var(--on-background)]/10 rounded-lg"></div>
                        <div className="h-8 w-8 bg-[var(--on-background)]/10 rounded-lg"></div>
                      </div>
                    </div>
                  </div>
                ))}
